...
class SolidMechStep(IntegratorStep):
    ...
    def stage1(self, d_idx, d_x0, d_y0, d_z0, d_x, d_y, d_z, d_u0, d_v0, d_w0,
               d_u, d_v, d_w, d_rho0, d_rho, d_au, d_av, d_aw,
               d_arho, d_s00, d_s01, d_s02, d_s11, d_s12, d_s22, d_s000,
               d_s010, d_s020, d_s110, d_s120, d_s220, d_as00, d_as01, d_as02,
               d_as11, d_as12, d_as22, dt):
        dtb2 = 0.5 * dt
...
class FSIScheme(Scheme):
    ...
    def get_equations(self):
        ...
        if len(self.fluids) > 0:
            ...
            for name in self.boundaries + self.solids + self.solid_supports:
            ...
            tmp = []
            for solid in self.boundaries + self.solids + self.solid_supports:
                tmp.append(
