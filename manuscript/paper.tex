...
\begin{figure}[!htpb]
  \centering
  \includegraphics[width=0.4\textwidth]{figures/ng_2020_hydrostatic_water_column_on_elastic_plate/good_vs_bad}
...
different particle resolutions, respectively
$h_e / delta_x = 10, h_e / delta_x = 10, h_e / delta_x = 10 $are adopted,
whose respective total number of particles are 1122232 and 1122323. The time
step of the fluid and solid phase are computed separately, but we use
