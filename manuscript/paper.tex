...
\subsection{Elastic solid governing equations}
...
\subsection{Modified equation for fluids}


\subsection{Modified equation for solids}



\section{SPH discretization of the equations}



\subsection{Discretized fluid equations}


\subsection{Discretized solid equations}
