"""Flexible slender body fluid interaction: Vector-based discrete element
method with Eulerian smoothed particle hydrodynamics.

$4.1 Non-linear quasi-static deflection of 2-D cantilever beam
"""
import numpy as np
...
class StaticCantileverBeamUnderTipLoad(Application):
    ...
    def create_particles(self):
        xp, yp = get_fixed_beam(self.L, self.H, self.dx_plate)
