...
class GuoBendingTestValidation(Application):
    def initialize(self):
        self.dt = 1e-4
        self.pfreq = 100
        self.total_time = 2.
        ...
        stage2 = [
            Group(equations=[
                ...
                ApplyTensionForce(dest='beam', sources=None,
                                  delta_fx=0., delta_fy=self.delta_fy,
                                  delta_fz=self.delta_fy, idx=self.force_idx),
    ...
    def post_process(self, info_fname):
        ...
        print(beam.total_force_applied_y[0])



if __name__ == '__main__':
    app = GuoBendingTestValidation()
    app.run()
